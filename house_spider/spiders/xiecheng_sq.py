...
class XiechengSqSpider(scrapy.Spider):
    name = "xiecheng_sq"
    ...
    def parse(self,response):
        ...
        for row in data:
            if row['city_id']:
                ...
                url = 'http://hotels.ctrip.com/domestic/tool/AjaxCityZoneNew.aspx?city='+str(row['city_id'])
                yield scrapy.Request(url, callback=self.parse_detail,meta={'city_id':row['city_id'],'city_name':row['name']})
